...
//for respawning helicopters on carrier, helo will respawn facing same direction as spawn
 // (place in vehicle init) veh = [this, 300, 0, 0, TRUE, FALSE] execVM "vehicle2.sqf"; 
